...
export class RoomsDataSource extends DataSource<Room> {
  ...
  constructor(private readonly _exampleDatabase: HotelApiService, public _paginator: MatPaginator, public _sort: MatSort) {
    super();
    ...
    return data.sort((a, b) => {
      ...
      switch (this._sort.active) {
        ...
        case 'title':
          ...
          break;
        case 'state':
          [propertyA, propertyB] = [a.capcity, b.capcity];
          break;
      }
